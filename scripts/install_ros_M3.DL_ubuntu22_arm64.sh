...
#*                                                                           *
#****************************************************************************/
#LIPSedge-DL-SDK-Linux-amd64-2.4.4.2_v1.8.2
...
function install_ros2 {
    ...
    if [ -d $USR_LIB/OpenNI2/Drivers ]; then
        ...
        cp -pf $SDK_ROOT/Redist/OpenNI2/Drivers/ModuleConfig.json $USR_LIB/OpenNI2/Drivers/ModuleConfig.json
        cp -pf $SDK_ROOT/Redist/OpenNI2/Drivers/libclproc.so $USR_LIB/OpenNI2/Drivers/libclproc.so
        cp -pf $SDK_ROOT/Redist/OpenNI2/Drivers/libcudaproc.so $USR_LIB/OpenNI2/Drivers/libcudaproc.so
