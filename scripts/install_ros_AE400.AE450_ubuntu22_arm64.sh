...
#*                                                                           *
#****************************************************************************/
#LIPSedge-AE400_AE450-SDK-Linux-amd64-2.4.4.2_v1.5.3
...
function install_ros2 {
    USR_LIB=$rootfs/usr/lib/aarch64-linux-gnu
    USR_LOCAL=$rootfs/usr/local
    # Install drivers for ROS environment
    if [ -d $USR_LIB/OpenNI2/Drivers ]; then
        #install driver to /usr/lib/x86_64-linux-gnu/OpenNI2/Drivers if found
        ...
        cp -pf $SDK_ROOT/Redist/OpenNI2/Drivers/librealsense2.so.2.43.0 $USR_LIB/OpenNI2/Drivers/librealsense2.so.2.43.0
        ...
        ln -sf librealsense2.so.2.43.0 librealsense2.so.2.43
        ln -sf librealsense2.so.2.43 librealsense2.so
        cd - > /dev/null

        #install OpenNI.ini to /usr/lib/x86_64-linux-gnu/
